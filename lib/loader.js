 ...
 * @param  {Object} attach   (optional) any attachment pass to loadedCB.
 * @param  {Function} loadedCB (optional) callback function for loaded module. 
 *                             It is a chance to modify the module from outside 
 *                             (eg: create proxy). 
 *                             loadCB declaration: function(path, module), 
 *                             the return value would replace the origin module 
 *                             instance.
 * @return {Object}          module that has loaded.
 */
module.exports.load = function(mpath, context, attach, loadedCB) {
	if(!mpath) {
	...
	return loadPath(mpath, context, attach, loadedCB);
};
...
var loadPath = function(path, context, attach, loadedCB) {
